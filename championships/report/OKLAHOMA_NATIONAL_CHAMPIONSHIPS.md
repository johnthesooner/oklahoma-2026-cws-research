# Oklahoma's 47 National Championships — An Evidence-First Accounting
...
**Headline:** Oklahoma officially claims **47 national championships** across **7 sports**
(the 47th: the **2026 baseball CWS title**, won June 22, 2026).
That number is **40 NCAA-administered team titles + 7 football "selector" titles**
(AP / Coaches' Poll / BCS — football has no NCAA-run championship in OU's title era).
The defining fact of the portfolio is **not** football: **79% of OU's national titles
...
| | Count |
|---|---|
| **Total claimed national championships** | **47** |
| NCAA-administered team titles | 40 |
| Football selector titles (AP/Coaches/BCS) | 7 |
| Shared / co-championships (within the 47) | 2 |
| Sports with ≥1 national title | 7 |
| Titles in 2000 or later | 28 (60%) |
| Titles in Olympic/non-revenue sports | 37 (79%) |

The 47 reconciles exactly: **12 + 8 + 8 + 7 + 7 + 3 + 2 = 47** (see §2). This matches
...
> football in the 47 because OU claims it, but we flag the basis in every table.
...
![Titles by sport](../charts/01_titles_by_sport.png)
...
| **Baseball** | **3** | NCAA team (CWS) | 1951, 1994, 2026 | Baer, Cochell, Johnson |
...
`[CONFIRMED — the official 47 leaves no room for any other sport]`

---

## 3. The timeline: two title clusters, fifty years apart

![Title timeline](../charts/02_title_timeline.png)
...
- **The modern Olympic-sport dynasty (2000–2026, 28 titles):** This is the real story. Men's
  gymnastics (8 titles 2002–2018), softball (8, 2000–2024), women's gymnastics (8, 2014–2026),
  plus football's last title (2000), golf's second (2017), and the **2026 baseball CWS title.**

![By decade](../charts/03_titles_by_decade.png)

The **2010s alone produced 12 national titles** — as many as OU's entire first 80 years of
men's gymnastics, and the most of any decade in school history. The 2020s already have **9**
through 2026.

![Cumulative](../charts/04_cumulative_titles.png)
...
Three active-era coaches account for **25 of the 47** (53%):
...
Two of the 47 are **co-championships** — full titles, but genuinely shared:
...
Both are counted in the 47 (OU and the NCAA count them), but a strict "outright titles only" view
would read OU at **45 outright + 2 shared**.
...
- **Baseball: CHAMPION.** OU **won the 2026 College World Series**, beating North Carolina 2–1 in the
  Finals (9–3, 2–6, **13–2**) — its **3rd** CWS title and first since 1994, now counted as **title #47.**
  An unseeded, 14–16-SEC team won it all. `[CONFIRMED — ESPN box 401874453; see the baseball module]`

So as of mid-2026, OU's championship engine is **women's gymnastics (peaking)** and now **baseball
(2026 champion)**, while **softball has cooled** and **men's gymnastics is knocking** — see the
`near_misses.csv` table.
...
that rests on **Olympic sports, not the football brand it's famous for.** 79% of its national titles
come from gymnastics, softball, wrestling, and golf; football is 15% and last won in 2000.

**FACT:** OU's championship production is **accelerating and recent** — 28 of 47 titles since 2000, a
record 12 in the 2010s, 9 already in the 2020s — driven by four coaches (Williams, Kindler, Gasso, and
now Johnson's 2026 baseball title).
...
- Computed aggregates regenerate deterministically via `analyze_championships.py`; counts cross-foot
  to 47 in `validate_championships.py`.
